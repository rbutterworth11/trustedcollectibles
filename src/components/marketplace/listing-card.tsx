...
export default function ListingCard({ listing }: ListingCardProps) {
  ...
  return (
    <div className="group relative rounded-lg border border-white/[0.07] bg-brand-card overflow-hidden hover:border-brand-amber/30 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-black/30 transition-all">
